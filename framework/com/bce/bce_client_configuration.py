...
from . import region
from .retry_policy import BackOffRetryPolicy
...
DEFAULT_REGION = region.BEIJING
DEFAULT_CONNECTION_TIMEOUT_IN_MILLIS = 60 * 1000
...
BCD_DEFAULT_CONFIG = BceClientConfiguration(
    protocol=DEFAULT_PROTOCOL,
    region=DEFAULT_REGION,
    connection_timeout_in_mills=DEFAULT_CONNECTION_TIMEOUT_IN_MILLIS,
    send_buf_size=DEFAULT_SEND_BUF_SIZE,
