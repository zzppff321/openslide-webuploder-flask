...
SDB_UNKNOWN_MESSAGE = Errcode("SDB_UNKNOWN_MESSAGE", -100, "Unknown message is received")
...
SDB_OUT_OF_BOUND = Errcode("SDB_OUT_OF_BOUND", -259, "Arguments are out of bound")
...
SDB_OM_PASSWD_CHANGE_SUGGEST = Errcode("SDB_OM_PASSWD_CHANGE_SUGGEST", -263, "Changing password is required")
...
SDB_DMS_TRUNCATED = Errcode("SDB_DMS_TRUNCATED", -321, "Collection is truncated")
SDB_RTN_CONF_NOT_TAKE_EFFECT = Errcode("SDB_RTN_CONF_NOT_TAKE_EFFECT", -322, "Some configuration changes didn't take effect")
SDB_SEQUENCE_EXIST = Errcode("SDB_SEQUENCE_EXIST", -323, "Sequence already exists")
SDB_SEQUENCE_NOT_EXIST = Errcode("SDB_SEQUENCE_NOT_EXIST", -324, "Sequence not exists")
SDB_SEQUENCE_EXCEEDED = Errcode("SDB_SEQUENCE_EXCEEDED", -325, "Sequence is exceeded")
SDB_DMS_CS_UNIQUEID_CONFLICT = Errcode("SDB_DMS_CS_UNIQUEID_CONFLICT", -326, "CS uniqueID conflict")
SDB_DMS_UNIQUEID_CONFLICT = Errcode("SDB_DMS_UNIQUEID_CONFLICT", -327, "CL uniqueID conflict")
SDB_DMS_CS_REMAIN = Errcode("SDB_DMS_CS_REMAIN", -328, "CS uniqueID conflict with remain cs")
SDB_DMS_REMAIN = Errcode("SDB_DMS_REMAIN", -329, "CL uniqueID conflict with remain cl")
SDB_CAT_CS_UNIQUEID_EXCEEDED = Errcode("SDB_CAT_CS_UNIQUEID_EXCEEDED", -330, "CS uniqueID exceeds the maximum")
SDB_CAT_CL_UNIQUEID_EXCEEDED = Errcode("SDB_CAT_CL_UNIQUEID_EXCEEDED", -331, "CL uniqueID exceeds the maximum")
SDB_AUTOINCREMENT_FIELD_CONFLICT = Errcode("SDB_AUTOINCREMENT_FIELD_CONFLICT", -332, "Autoincrement field conflicts on collection")
SDB_AUTOINCREMENT_FIELD_NOT_EXIST = Errcode("SDB_AUTOINCREMENT_FIELD_NOT_EXIST", -333, "Autoincrement field does not exist on collection")
SDB_OPERATION_CONFLICT = Errcode("SDB_OPERATION_CONFLICT", -334, "Operations conflict")
SDB_CAT_GLOBALID_EXCEEDED = Errcode("SDB_CAT_GLOBALID_EXCEEDED", -335, "GlobalID exceeds the maximum")
SDB_DPS_INVALID_LOCK_UPGRADE_REQUEST = Errcode("SDB_DPS_INVALID_LOCK_UPGRADE_REQUEST", -336, "Invalid lock upgrade request")
SDB_DMS_CS_RENAMING = Errcode("SDB_DMS_CS_RENAMING", -337, "Renaming the collection space is in progress")
SDB_CLS_DATA_NOT_SYNC = Errcode("SDB_CLS_DATA_NOT_SYNC", -338, "Data not yet synchronized")
SDB_IXM_KEY_NOTNULL = Errcode("SDB_IXM_KEY_NOTNULL", -339, "Any field of index key should exist and cannot be null")
SDB_RTN_EXIST_INDOUBT_TRANS = Errcode("SDB_RTN_EXIST_INDOUBT_TRANS", -340, "Exists in-doubt transaction")
SDB_RTN_ALREADY_IN_AUTO_TRANS = Errcode("SDB_RTN_ALREADY_IN_AUTO_TRANS", -341, "Exists unfinished auto-commit transaction")
SDB_FMP_FUNC_EXIST = Errcode("SDB_FMP_FUNC_EXIST", -342, "Stored procedure exists")
...
_errcode_map = {
    ...
    -263: SDB_OM_PASSWD_CHANGE_SUGGEST,
    ...
    -321: SDB_DMS_TRUNCATED,
    -322: SDB_RTN_CONF_NOT_TAKE_EFFECT,
    -323: SDB_SEQUENCE_EXIST,
    -324: SDB_SEQUENCE_NOT_EXIST,
    -325: SDB_SEQUENCE_EXCEEDED,
    -326: SDB_DMS_CS_UNIQUEID_CONFLICT,
    -327: SDB_DMS_UNIQUEID_CONFLICT,
    -328: SDB_DMS_CS_REMAIN,
    -329: SDB_DMS_REMAIN,
    -330: SDB_CAT_CS_UNIQUEID_EXCEEDED,
    -331: SDB_CAT_CL_UNIQUEID_EXCEEDED,
    -332: SDB_AUTOINCREMENT_FIELD_CONFLICT,
    -333: SDB_AUTOINCREMENT_FIELD_NOT_EXIST,
    -334: SDB_OPERATION_CONFLICT,
    -335: SDB_CAT_GLOBALID_EXCEEDED,
    -336: SDB_DPS_INVALID_LOCK_UPGRADE_REQUEST,
    -337: SDB_DMS_CS_RENAMING,
    -338: SDB_CLS_DATA_NOT_SYNC,
    -339: SDB_IXM_KEY_NOTNULL,
    -340: SDB_RTN_EXIST_INDOUBT_TRANS,
    -341: SDB_RTN_ALREADY_IN_AUTO_TRANS,
    -342: SDB_FMP_FUNC_EXIST
}
